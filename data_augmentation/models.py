...
from transformers import LukeModel, LukeConfig, LukeTokenizer
...
class TransformerEncoder(torch.nn.Module):
    def __init__(self, args, devive):
        ...
        if args.embedding_type == "bert":
            ...
            self.model = LukeModel.from_pretrained(pretrained_model_name_or_path=args.pretrained_dir,
                                                   config=self.config)
        else:
